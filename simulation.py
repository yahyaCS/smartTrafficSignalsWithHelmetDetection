...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        path = f"/Users/my/Desktop/FYP2/darkflow/images/{direction}/{vehicleClass}.png"  # Ensure this path is correct
            ...
            if(self.willTurn==1):
                if(self.crossed==0 or self.x>mid[self.direction]['x']):
                    ...
                    if(self.turned==0):
                        ...
                        if(self.rotateAngle==90):
                            self.turned = 1
                            # path = "/Users/my/Desktop/FYP2/darkflow/images/down" + directionNumbers[((self.direction_number+1)%noOfSignals)] + "/" + self.vehicleClass + ".png"
...
class Main:
    ...
    background = pygame.image.load('/Users/my/Desktop/FYP2/darkflow/mod_int.png')

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    redSignal = pygame.image.load('/Users/my/Desktop/FYP2/darkflow/signals/red.png')
    yellowSignal = pygame.image.load('/Users/my/Desktop/FYP2/darkflow/signals/yellow.png')
    greenSignal = pygame.image.load('/Users/my/Desktop/FYP2/darkflow/signals/green.png')
